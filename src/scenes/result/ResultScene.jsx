      ...
      >
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'grid', placeItems: 'center' }}>
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 2, maxWidth: '100%', fontSize: 56, fontWeight: 950, color: rootText, lineHeight: 1.12, letterSpacing: 0.6, textTransform: 'uppercase', textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', textShadow: isOwcs ? 'none' : '0 4px 18px rgba(0,0,0,0.25)', opacity: 0, animation: 'owbtWinnerTextUp 600ms cubic-bezier(0.16, 1, 0.3, 1) 600ms forwards' }}>
              {winnerName}
            </div>
